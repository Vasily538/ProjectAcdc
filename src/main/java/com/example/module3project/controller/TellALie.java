...
@WebServlet("/tell-a-lie")
public class TellALie extends HttpServlet {
    ...
    public void init() throws ServletException {
        message1 = "Твою ложь разоблачили.";
        message2 = "Поражение";
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        RequestDispatcher requestDispatcher = req.getRequestDispatcher("tellALie.jsp");
